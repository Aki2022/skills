...
| **Design/Asset Plugin** | `origin-brand/plugins` の各箱（別 skill）        | ブランド・デザインシステム固有の DESIGN.md / tokens / assets / templates | 媒体固有の実装制約                 |
...
User Task
  ...
  → 倉庫 origin-brand に問い合わせる（選択規則・extends・ライセンスゲートは倉庫が持つ）

...
段階移行のあいだ、プロンプトの器の定義は次の2箇所に**二重に**存在する:
  ...
  側1: own-image-gen/references/prompt-shell.md
       「## 順序と各フィールドの役割」表。各行 `| <番号> | \\`<ラベル>\\` | ... |`
  側2: own-pptx-build/style-guide/imagegen-prompt-convention.md
...
# own-image-gen/scripts/check_shell_parity.py から見た正典パス
...
DEFAULT_CONVENTION = _REPO_ROOT / "own-pptx-build" / "style-guide" / "imagegen-prompt-convention.md"
